...
public class TelegramMessageResponse {
    ...
    public TelegramMessageResponse(String method, long chat_id, String text,
                                  String parse_mode,
    ...
    public TelegramMessageResponse(long chat_id, String text) {
        this("sendMessage",
             chat_id,
             text,
             "Markdown",
    ...
    public TelegramMessageResponse(long chat_id, String text, String parse_mode){
        this("sendMessage",
             chat_id,
             text,
             parse_mode,
